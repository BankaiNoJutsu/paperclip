...
export const CONNECT_SOURCE_NAMES: Record<string, string> = {
  ...
  codex_local: "OpenAI",
  grok_local: "Grok",
  // OpenCode is a harness, not a vendor — it reaches several. Listed so the
  // fallback never renders the adapter type at a customer, which is what
  // "Provide your opencode_local API key" was doing.
